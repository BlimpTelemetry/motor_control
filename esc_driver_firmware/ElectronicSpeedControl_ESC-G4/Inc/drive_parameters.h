...
#define PID_TORQUE_KP_DEFAULT               2499
#define PID_TORQUE_KI_DEFAULT               2333
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2499
#define PID_FLUX_KI_DEFAULT                 2333
...
#define PID_SPEED_KP_DEFAULT                3144/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                141/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_VOLTAGE_THRESHOLD_V              13.3 /*!< Over-voltage threshold */
