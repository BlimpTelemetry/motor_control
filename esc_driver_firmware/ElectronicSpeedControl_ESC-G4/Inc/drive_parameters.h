...
#define PID_TORQUE_KP_DEFAULT               3587
#define PID_TORQUE_KI_DEFAULT               2242
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 3587
#define PID_FLUX_KI_DEFAULT                 2242
...
#define PID_SPEED_KP_DEFAULT                3749/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                27/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM            2500
#define DEFAULT_TARGET_SPEED_UNIT           (DEFAULT_TARGET_SPEED_RPM*SPEED_UNIT/U_RPM)
#define DEFAULT_TORQUE_COMPONENT_A          0
#define DEFAULT_FLUX_COMPONENT_A            0

/**************************    FIRMWARE PROTECTIONS SECTION   *****************/
#define OV_VOLTAGE_THRESHOLD_V              13.2 /*!< Over-voltage threshold */
#define UD_VOLTAGE_THRESHOLD_V              8.0 /*!< Under-voltage threshold */
